...
public class PiCalcTest {
    ...
    public void shouldCalculatePiDigitsWithThreads() throws InterruptedException {
        byte[] threatResult = {15,6,10,8,8,8,5,10,3};
        assertArrayEquals(threatResult,PiDigits.getDigits(3,9,1));
        assertArrayEquals(threatResult,PiDigits.getDigits(3,9,2));
        assertArrayEquals(threatResult,PiDigits.getDigits(3,9,5));
    }
